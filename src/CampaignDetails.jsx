...
import './campaignDetails.css'; // Ensure this includes the updated footer styles
  ...
  <span style={{ color: '#283044' }}>CREATE YOUR OWN CAMPAIGN</span>
      ...
      <div className="campaign-layout">
        ...
        <section className="campaign-info">
          ...
          <p>
  Starting a campaign on CrowdFunding gives you the platform to bring your ideas to life. Whether it’s a project that supports a cause, a business venture, or a personal goal, a well-executed campaign can attract the right backers and create lasting change. By leveraging the power of community support, you can reach individuals who resonate with your mission and want to see your vision succeed. With a compelling story, the right approach, and a strong network, your campaign can become a catalyst for growth and innovation. It's not just about raising funds; it's about creating connections, building trust, and inspiring others to join you in making a difference.
</p>
  ...
  <li><strong>Make an Impact:</strong> Have a lasting effect by funding projects that solve real-world problems, benefiting others in the long term.</li>
        ...
        <form id="campaignForm" onSubmit={handleSubmit} className="campaign-form">
          ...
          <input
            ...
            min="1"
            required
            placeholder="Enter voting limit"
          />
